    ...
    try:
        ...
        for section in sections :
            if section.text == 'SYNOPSIS':
                synopsis_div = section.parent.find('div', class_='text-[14px] leading-[17px] pr-[20px] text-white')
            elif section.text == 'CAST':
                cast_div = section.parent.find('div', class_='text-[14px] leading-[17px] text-white')
            elif section.text == 'GENRE':
                genre_div = section.parent.find('div', class_='text-white text-[14px] lg:leading-[14px] lg:my-0 my-auto')
            elif section.text == 'LANGUAGE':
                language_div = section.parent.find('div', class_='text-white text-[14px] leading-[14px] lg:my-0 my-auto')
            elif section.text == 'RATING':
                rating_div = section.parent.find('div', class_='movie-rating text-white text-[14px] leading-[14px] lg:my-0 my-auto whitespace-nowrap')
            elif section.text == 'RUNTIME':
                runtime_div = section.parent.find('div', class_='text-white text-[14px] leading-[14px] lg:my-0 my-auto')
            elif section.text == 'OPENING':
                opening_div = section.parent.find('div', class_='ext-white text-[15px] leading-[14px] whitespace-nowrap lg:my-0 my-auto')
